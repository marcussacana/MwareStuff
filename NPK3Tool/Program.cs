...
namespace NPK3Tool
{
    static class Program
    {
        ...
        readonly static (string Game, byte[] Key, Encoding Encoding, int NPKVersion, bool NPKSegmentation, uint NPKMinorVersion)[] Games = new (string Game, byte[] Key, Encoding Encoding, int NPKVersion, bool NPKSegmentation, uint NPKMinorVersion)[] {
            ...
            ("sweet pool (Steam)", new byte[] {
                0x98, 0x98, 0x52, 0x43, 0x5F, 0xF0, 0xCF, 0xDD, 0x84, 0x64, 0xB4, 0xC6, 0x2C, 0xB5, 0xBC, 0x7A,
                0xE8, 0xCC, 0x7B, 0x22, 0x0E, 0x95, 0x2D, 0xEA, 0x48, 0x51, 0xE6, 0x49, 0x53, 0x60, 0xCE, 0x34
            }, Encoding.UTF8            , 2, true, 2u),
            ("Togainu no Chi –Lost Blood– (Jast USA)", new byte[] {
            ...
            ("Togainu no Chi –Lost Blood– (Steam)", new byte[] {
                0x18, 0x84, 0xB5, 0x91, 0xCE, 0x89, 0xE6, 0xAD, 0xF0, 0x9D, 0x76, 0x9E, 0x33, 0xE2, 0xA8, 0x89,
                0x5C, 0x02, 0xAB, 0x5C, 0x3A, 0xFC, 0x8F, 0x7E, 0x70, 0xD8, 0x6F, 0xB0, 0x92, 0x36, 0xDC, 0x33
            }, Encoding.UTF8            , 2, true, 2u),
            ("Togainu no Chi True Blood NITRO ARCHIVE (Steam)", new byte[] {
                0x25, 0x77, 0xBC, 0xFA, 0xD4, 0x00, 0xFB, 0x74, 0x25, 0xFA, 0x66, 0xC9, 0x8F, 0x97, 0x46, 0x3D,
                0x44, 0xDF, 0x19, 0x85, 0x91, 0xD0, 0xF3, 0x8F, 0x9A, 0x97, 0x7A, 0x70, 0x89, 0xDF, 0x86, 0x42
            }, Encoding.UTF8            , 3, true, 1u),
            ("Mojika: Truth Rears Its Ugly Head (Steam)", new byte[] {
            ...
            ("Jingai Makyou - Windows 10 Support Edition", new byte[] {
                0x58, 0xAC, 0xA2, 0x11, 0xE8, 0xC4, 0xEE, 0xBA, 0x76, 0x5E, 0x19, 0xAF, 0x37, 0x1E, 0x34, 0xBB,
                0x9D, 0x5B, 0x93, 0x96, 0x1E, 0x80, 0x48, 0x8D, 0x02, 0xFD, 0x56, 0x83, 0x70, 0x9B, 0x24, 0xE7
            }, Encoding.UTF8            , 2, true, 2u),
            ("Phantom PHANTOM OF INFERNO NITRO ARCHIVE (Steam)", new byte[] {
                0x92, 0x91, 0x93, 0xCA, 0xED, 0xAC, 0x4D, 0x3D, 0xF2, 0x97, 0x48, 0x0B, 0xF5, 0xC3, 0xE7, 0x5C,
                0x80, 0x77, 0x26, 0x85, 0x7A, 0x26, 0x6E, 0x47, 0x74, 0xDC, 0x19, 0x0C, 0x06, 0x3B, 0x46, 0xA9 
            }, Encoding.UTF8            , 3, true, 1u),
        };
    }
}
